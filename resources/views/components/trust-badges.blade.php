...
<div {{ $attributes->twMerge(['class' => 'grid grid-cols-2 gap-6 sm:grid-cols-4']) }}>
    <div class="flex flex-col items-center text-center">
        <div class="flex size-12 items-center justify-center rounded-full bg-zinc-100 dark:bg-zinc-800">
            <flux:icon.truck variant="outline" class="size-6 text-zinc-600 dark:text-zinc-400" />
        </div>
    ...
    <div class="flex flex-col items-center text-center">
        <div class="flex size-12 items-center justify-center rounded-full bg-zinc-100 dark:bg-zinc-800">
            <flux:icon.shield-check variant="outline" class="size-6 text-zinc-600 dark:text-zinc-400" />
        </div>
    ...
    <div class="flex flex-col items-center text-center">
        <div class="flex size-12 items-center justify-center rounded-full bg-zinc-100 dark:bg-zinc-800">
            <flux:icon.arrow-path variant="outline" class="size-6 text-zinc-600 dark:text-zinc-400" />
        </div>
    ...
    <div class="flex flex-col items-center text-center">
        <div class="flex size-12 items-center justify-center rounded-full bg-zinc-100 dark:bg-zinc-800">
            <flux:icon.chat-bubble-left-right variant="outline" class="size-6 text-zinc-600 dark:text-zinc-400" />
        </div>
