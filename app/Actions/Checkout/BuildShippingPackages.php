...
final class BuildShippingPackages
{
    ...
    /**
     * Fold the shippable lines into a single package: weights add up, the
     * largest dimensions win, expressed in the unit system the store ships with.
     *
     * @param  Collection<int, CartLine>  $lines
     * @return array<int, Package>
     */
    public function handle(Collection $lines): array
    {
        $weight = 0.0;
        $length = 0.0;
        $width = 0.0;
